...
#readonly active_env="${DIR}/.env-cic-bulk-import"
#readonly active_env="${DIR}/.env-cis-to-cic"
#readonly active_env="${DIR}/.env-rules-wrapper-api-explorer"
#readonly active_env="${DIR}/.env-actions-gallery"
#readonly active_env="${DIR}/.env-amin-jp-api-explorer"
#readonly active_env="${DIR}/.env-aminsplayground-api-explorer"
#readonly active_env="${DIR}/.env-atl-sus2"
