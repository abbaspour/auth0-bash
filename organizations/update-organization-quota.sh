...
function usage() {
    cat <<END >&2
USAGE: $0 [-e env] [-a access_token] [-i org_id] [-m k1:v1,k2:v2] [-v|-h]
...
eg,
     $0 -i org_btj4iOO78LOT7Fbk -h 10 -d 100 -f
END
    exit $1
}
...
declare -r EXPECTED_SCOPES=("update:organizations") # Either of these scopes would do
...
[[ -z "${org_id}" ]] && {  echo >&2 "ERROR: org_id undefined." ;  usage 1; }
...
curl -s --request PATCH \
    ...
    --url "${AUTH0_DOMAIN_URL}api/v2/organizations/${org_id}"
