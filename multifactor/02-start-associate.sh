...
declare -r response_json=`curl -s -H "Authorization: Bearer ${mfa_token}" --header 'content-type: application/json' -d "${BODY}" https://${AUTH0_DOMAIN}/mfa/associate`
